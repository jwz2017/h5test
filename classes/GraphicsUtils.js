 ...
 * @param {number} wradius 宽度半径
 * @param {number} hradius 高度半径
 * @param {number} fromAngle 起点角度
 * @param {number} toAngle 终点角度
 */
